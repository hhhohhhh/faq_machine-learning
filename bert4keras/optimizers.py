...
class Adam(keras.optimizers.Optimizer):
    ...
    def _create_slots(self, var_list):
        ...
        A slot is basically a placeholder where we will keep extra value.
        A slot is per variable where a variable could be weight or bais.
        """
        for var in var_list:
            self.add_slot(var, 'm')
            self.add_slot(var, 'v')
    ...
    def _resource_apply_dense(self, grad, var):
        """
         This method is called on every step. It provides your two variables grad and var.
         Both grad and var are basically tensors (or vectors) and contain the value of gradients (rate of change of loss wrt variable) and the variables.
        """
