...
------------      -------    --------    -----------
2022/1/19 15:10   wangfc      1.0         None
"""
...
from utils.constants import EXTRACTOR, NO_ENTITY_TAG, ENTITY_ATTRIBUTE_START, ENTITY_ATTRIBUTE_END, ENTITIES, \
    TEXT, ENTITY_ATTRIBUTE_TYPE, ENTITY_ATTRIBUTE_GROUP, ENTITY_ATTRIBUTE_ROLE, ENTITY_ATTRIBUTE_VALUE, INTENT,\
    ENTITY_ATTRIBUTE_CONFIDENCE_TYPE, ENTITY_ATTRIBUTE_CONFIDENCE_ROLE, \
    ENTITY_ATTRIBUTE_CONFIDENCE_GROUP, TOKENS_NAMES, SINGLE_ENTITY_ALLOWED_INTERLEAVING_CHARSET, SPLIT_ENTITIES_BY_COMMA, \
    SPLIT_ENTITIES_BY_COMMA_DEFAULT_VALUE
from models.train_utils import init_split_entities
