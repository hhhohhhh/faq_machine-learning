...
class Features:
    ...
    def __init__(
        ...
        self.type = feature_type # 'sequence' or 'sentence'
        self.origin = origin
        self.attribute = attribute

    def __repr__(self):
        return f"features is_dense={self.is_dense()},shape={self.features.shape}," \
               f"type={self.type},origin={self.origin},attribute={self.attribute}"
