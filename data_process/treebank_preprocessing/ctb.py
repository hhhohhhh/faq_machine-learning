...
from data_process.treebank_preprocessing.utility import make_sure_path_exists, eprint, combine_files
...
if __name__ == '__main__':
    ...
    parser.add_argument("--ctb", #required=True,
                        help='The root path to Chinese Treebank 5.1',default='./corpus/nltk/ctb')
    parser.add_argument("--output", #required=True,
                        help='The folder where to store the output train.txt/dev.txt/test.txt',
                        default='./corpus/nltk/ctb/'+task)
    parser.add_argument("--task", dest="task", default=task,
