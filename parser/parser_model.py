...
class ParserModel(nn.Module):
    ...
    def __init__(self, embeddings, n_features=36,
        hidden_size=200, n_classes=3, dropout_prob=0.5,device = 'cpu'):
        ...
        # hidden_to_logits
        self.hidden_to_logits = nn.Linear(in_features=self.hidden_size,out_features=n_classes)
    ...
    def embedding_lookup(self, t):
        ...
        # t shape = (batch_size, n_feature)
        batch_size = t.shape[0]
        # embeddings = (batch_size,n_features, embedding_size)
        embeddings = self.pretrained_embeddings(t)
        # reshape to (batch_size,n_features * embedding_size)
        embeddings_reshaped = embeddings.view(batch_size,-1)
    ...
    def forward(self, t):
        ...
        # embeddings = (batch_size, n_features*embedding_size)
        embeddings = self.embedding_lookup(t=t)

        # hiddens =  (batch_size, hidden_size)
        hiddens = self.embed_to_hidden(embeddings)

        non_linears = F.relu(hiddens)

        dropouts = self.dropout(non_linears)

        # logits =  (batch_size, n_classes)
        logits = self.hidden_to_logits(dropouts)
        return logits