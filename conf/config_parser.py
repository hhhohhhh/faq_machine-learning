...
SUBDATASET_NAME = config_parser.get('train','subdataset_name')
DATA_OUTPUT_SUBDIR = config_parser.get('train','data_output_subdir')

RAW_FAQ_KNOWLEDGE_DEFINITION_FILENAME = config_parser.get('train','raw_faq_knowledge_definition_filename')

FAQ_INTENT_ATTRIBUTE_DEFINITION_SHEET_NAME =  config_parser.get('train','faq_intent_attribute_definition_sheet_name')
FAQ_ENTITY_DEFINITION_SHEET_NAME =  config_parser.get('train','faq_entity_definition_sheet_name')

STANDARD_QUESTION_KNOWLEDGE_SHEET_NAME= config_parser.get('train','standard_question_knowledge_sheet_name')
RAW_STANDARD_TO_EXTEND_DATA_FILENAME=  config_parser.get('train','raw_standard_to_extend_data_filename')
STANDARD_TO_EXTEND_DATA_SHEET_NAME =  config_parser.get('train','standard_to_extend_data_sheet_name')
ENTITY_DATA_FILENAME =  config_parser.get('train','entity_data_filename')

DATASET_DIR = os.path.join(CORPUS,DATASET_NAME)
DATA_DIR = os.path.join(DATASET_DIR,DATA_OUTPUT_SUBDIR)

TEST_DATA_SUBDIR = config_parser.get('train','test_data_subdir')
...
RASA_TRAIN_DATA_SUBDIRNAME = config_parser.get('train','rasa_train_data_subdirname')
RASA_TEST_DATA_SUBDIRNAME = config_parser.get('train','rasa_test_data_subdirname')
