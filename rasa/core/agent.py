...
class Agent:
    ...
    def __init__(
        ...
        # 默认创建 InMemoryTrackerStore，对话历史都存储在内存中
    ...
    async def handle_message(
        ...
        **kwargs: Any,
        ...
        output_with_nlu_parse_data = kwargs.get("output_with_nlu_parse_data")
        async with self.lock_store.lock(message.sender_id):
            return await processor.handle_message(message,output_with_nlu_parse_data)
