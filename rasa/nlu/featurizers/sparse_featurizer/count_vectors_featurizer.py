...
class CountVectorsFeaturizer(SparseFeaturizer):
    ...
    def _load_vocabulary(self) -> Dict[Text,Set[Text]]:
        ...
        if self.vocabulary_file:
            ...
            vocabulary = {rasa.shared.nlu.constants.TEXT :set(vocabulary_data)}
            return vocabulary
    ...
    def _create_independent_vocab_vectorizers(
        ...
        for attribute in cls._attributes_for(parameters["analyzer"]):
            ...
            min_df = parameters["min_df"] if attribute == rasa.shared.nlu.constants.TEXT else cls.defaults.get("min_df")
