...
from typing import Text, Optional, List, Dict, Set, Any, Tuple, Union
import logging
...
class TrainingDataImporter:
    ...
    def load_nlu_importer_from_config(
        ...
        """
        logger.info(f"运行 {__name__}.load_nlu_importer_from_config 函数: 创建 file_importer")
    ...
    def load_from_dict(
        ...
        logger.info(f"运行 {__name__}.load_from_dict 函数：创建 E2EImporter(ResponsesSyncImporter(CombinedDataImporter([RasaFileImporter])))")
